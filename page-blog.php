    ...
    <div class="ee-blog-wrap">
        ...
        <aside class="ee-blog-side-r" aria-label="Sidebar">
            <div class="ee-blog-social">
                <ul>
                    <li><a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo urlencode(home_url('/blog/')); ?>" target="_blank" rel="noopener"><?php echo ee_icon('ti-brand-linkedin', 24); ?> <span>LinkedIn</span></a></li>
                    <li><a href="https://api.whatsapp.com/send?text=<?php echo urlencode(home_url('/blog/')); ?>" target="_blank" rel="noopener"><?php echo ee_icon('ti-brand-whatsapp', 24); ?> <span>WhatsApp</span></a></li>
                    <li><a href="mailto:?subject=ExtraaEdge%20Blog&body=<?php echo urlencode(home_url('/blog/')); ?>"><?php echo ee_icon('ti-mail', 24); ?> <span>E-mail</span></a></li>
                    <li><a href="#" class="ee-soc-copy" data-url="<?php echo esc_attr(home_url('/blog/')); ?>"><?php echo ee_icon('ti-link', 24); ?> <span>Copy Link</span></a></li>
