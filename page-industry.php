<?php
/**
 * Page Template — auto-loaded for any WordPress Page whose slug is "industry"
 * URL: /industry/
 *
 * Setup (non-coder):
 *   1. WP Admin → Pages → Add New
 *   2. Title: Industry
 *   3. Make sure the URL slug under the title reads exactly: industry
 *   4. Leave the editor body blank (this template renders the design)
 *   5. Publish
 *   6. Visit https://your-site.com/industry/
 *
...
<script type="application/ld+json">
{
  ...
  "url": "<?php echo esc_url(home_url('/industry/')); ?>",
  "numberOfItems": 6,
  "itemListElement": [
