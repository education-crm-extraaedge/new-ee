<?php
/**
 * Single Product Template — mirrors single-industry.php exactly (same tabbed
 * meta-box editor and post-meta keys), so every product page gets the same
 * design: hero + form, trust badges, TOC right, quick-nav rail, mobile fixes.
 *
...
get_header();
/* deployment marker */ echo "\n<!-- ee-product-tpl v2026-07-21-industry-clone -->\n";
?>
