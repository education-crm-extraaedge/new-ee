...
get_header();
/* deployment marker */ echo "\n<!-- ee-industry-tpl v2026-07-21-formcompact -->\n";
?>
...
@media(max-width:1024px){.alt-layout{flex-direction:column;text-align:center;padding:20px 20px;gap:30px}.alt-content{order:1!important}.alt-visual{order:2!important;margin-top:16px;margin-bottom:0;width:100%}.feature-item{text-align:left}.feat-card{flex:0 1 calc(25% - 12px);max-width:none}.bottom-cta-inner{flex-direction:column;gap:30px}.cta-h3{margin-left:auto;margin-right:auto}.ai-demo-inner{grid-template-columns:minmax(0,1fr);gap:30px}.ai-demo-inner>*,.testi-cards>*,.alt-layout>*{min-width:0;max-width:100%}.ai-cta-content{text-align:center}.ai-cta-sub,.btn-cta-rounded{margin-left:auto;margin-right:auto}.ai-trust{justify-content:center}.testi-cards{grid-template-columns:minmax(0,1fr)}}
@media(max-width:768px){.hero{padding:30px 0}.hero-layout{padding:20px 18px 30px}.stats-grid{grid-template-columns:repeat(3,1fr);gap:8px}.stat-card{padding:12px 6px}.stat-num{font-size:20px}.stat-label{font-size:7.5px;letter-spacing:.3px}.features-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;padding:0 16px}.feat-card{max-width:none;padding:10px 6px}.feat-title{font-size:10.5px;gap:5px}.feat-img-wrap{height:48px;margin-bottom:6px}.hero-badge{white-space:nowrap;max-width:calc(100vw - 52px);overflow:hidden;font-size:clamp(6.5px,2.05vw,9px);letter-spacing:.2px;padding:7px 10px;gap:5px}.secure-label{white-space:nowrap;font-size:clamp(8px,2.4vw,10px);letter-spacing:1px}.hero-form-card::before{font-size:clamp(7px,2.2vw,8.5px);padding:5px 12px;letter-spacing:.6px;top:-12px;max-width:calc(100% - 24px);overflow:hidden;text-overflow:ellipsis}.hero-form-card label:not(:has(input[type="checkbox"])),#ee-form-7 label:not(:has(input[type="checkbox"])){white-space:nowrap!important;overflow:hidden!important;font-size:clamp(9.5px,3.2vw,13px)!important;letter-spacing:0!important}.hero-form-card{padding:16px 14px 18px}.hero-form-card h3,#ee-form-7 h3{font-size:17px!important;margin-bottom:2px!important}.hero-form-card p,#ee-form-7 p{font-size:11.5px!important;margin-bottom:8px!important}.hero-form-card label,#ee-form-7 label{margin-bottom:3px!important}.hero-form-card input[type="text"],.hero-form-card input[type="email"],.hero-form-card input[type="tel"],.hero-form-card input[type="url"],.hero-form-card input[type="number"],.hero-form-card select,.hero-form-card textarea,#ee-form-7 input[type="text"],#ee-form-7 input[type="email"],#ee-form-7 input[type="tel"],#ee-form-7 input[type="url"],#ee-form-7 input[type="number"],#ee-form-7 select,#ee-form-7 textarea{padding:8px 12px!important;font-size:13px!important;border-radius:8px!important}#ee-form-7 form>div,#ee-form-7 form>div>div{margin-bottom:7px!important}.hero-form-card input[type="submit"],.hero-form-card button[type="submit"],#ee-form-7 input[type="submit"],#ee-form-7 button[type="submit"]{padding:11px 20px!important;font-size:14px!important;border-radius:10px!important}.hero-form-card label:has(input[type="checkbox"]),#ee-form-7 label:has(input[type="checkbox"]),#ee-form-7 div:has(>input[type="checkbox"]),#ee-form-7 p:has(>input[type="checkbox"]){font-size:10.5px!important;line-height:1.45!important;margin:2px 0 8px!important}.secure-label{margin-top:10px}.edu-crm-p{text-align:left}html,body{overflow-x:hidden}.btn-primary,.btn-secondary{width:100%;text-align:center}.cta-row{flex-direction:column}.float-badge{display:none}.product-grid{grid-template-columns:repeat(2,1fr);gap:10px}.product-item{padding:12px}.product-logo{width:34px;height:34px;margin-bottom:8px}.product-item h3{font-size:13px}.growth-card{flex-direction:column;text-align:center;gap:8px;padding:14px 14px}.growth-val{font-size:1.35rem}.growth-text{font-size:12px;line-height:1.5}.trust-bar{flex-direction:column;align-items:center;gap:12px;text-align:center}.trust-rating{text-align:center}.compliance-row{flex-wrap:nowrap;justify-content:center;gap:16px}.logo-section{padding:24px 12px}.btn-rounded{width:100%}.testi-metrics{grid-template-columns:1fr 1fr}.ai-story-engine{display:none!important}.faq-trigger{padding:16px 18px}.faq-q{font-size:15px}.faq-inner{padding:0 18px 20px}.edu-crm-section,.features-section,.alt-section,.bottom-cta,.testimonials-section,.ai-demo-section,.faq-section{padding:28px 0}}
