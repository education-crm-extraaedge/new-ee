<?php
/**
 * Category Archive — "company" slug
 * URL: /company/
 *
 * Loaded automatically by WordPress for the "company" category archive.
 * Replaces the default category archive grid with the ExtraaEdge Company
 * landing design (cards for About, Customers, Careers, Investors, Team,
 * Partner). All <html>, <head>, <body>, and #main-content come from
 * header.php; this file only emits the section markup, scoped styles,
 * and the JSON-LD + reveal script.
 *
 * @package ExtraaEdge
 */
  ...
  <div class="ee-co-v1__wrap">
    ...
    <ul class="ee-co-v1__grid" role="list" aria-label="Company pages" style="list-style:none;padding:0;margin:0;" itemprop="itemListElement">
      ...
      <li itemprop="item" itemscope itemtype="https://schema.org/WebPage" style="display:contents;">
        ...
        <a class="ee-co-v1__card ee-co-v1__reveal" href="https://www.extraaedge.com/videos/customer-stories/" aria-label="Customers – Our happy customers" itemprop="url" style="transition-delay:.1s">
          <div class="ee-co-v1__icon" aria-hidden="true">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Customers",            "url": "https://www.extraaedge.com/videos/customer-stories/" },
