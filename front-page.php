...
?>
<!-- ee-front-tpl v2026-07-26-headingorder -->
<!--
...
.steps{margin-top:24px;display:flex;flex-direction:column;gap:4px}.step{position:relative;display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:12px;cursor:pointer;border:1px solid transparent;transition:background .3s,border-color .3s;user-select:none}.step:hover{background:var(--panel)}.step.on{background:var(--panel);border-color:var(--hair);box-shadow:0 10px 30px rgba(3,10,26,.18)}body.day .step.on{box-shadow:0 10px 30px rgba(25,51,93,.08)}.step .tno{font:700 10px/1 ui-monospace,Menlo,monospace;color:var(--faint);width:20px;flex:none;transition:color .3s}.step.on .tno{color:var(--orange)}.step .tt{flex:1;min-width:0}.step .tt b{font:600 13px/1.3 Inter;color:var(--fg);display:block;transition:color 1.2s}.step .tt span{font:500 10.5px/1 Inter;color:var(--faint);transition:color 1.2s}.step .tm{font:600 10.5px/1 ui-monospace,Menlo,monospace;color:var(--sub);flex:none;transition:color 1.2s}.step.on .tm{color:var(--orange)}.step .pbar{position:absolute;left:12px;right:12px;bottom:4px;height:2px;border-radius:2px;background:var(--hair);overflow:hidden;opacity:0;transition:opacity .3s}.step.on .pbar{opacity:1}.step .pbar i{display:block;height:100%;width:0;background:linear-gradient(90deg,var(--orange2),var(--orange))}.step.done .tno{color:var(--green)}.pctrl{display:none;align-items:center;gap:10px;margin-top:16px}/* desktop: scroll drives the story - no manual controls; the prev/next buttons stay in the DOM because phones relocate them onto the stage as side arrows */.pbtn{width:34px;height:34px;border-radius:50%;border:1px solid var(--hair);background:var(--panel);color:var(--fg);display:flex;align-items:center;justify-content:center;cursor:pointer;transition:border-color .3s,background 1.2s,color 1.2s}.pbtn:hover{border-color:var(--orange)}.pctrl span{font:500 10.5px/1 Inter;color:var(--faint);transition:color 1.2s}/* stage */
