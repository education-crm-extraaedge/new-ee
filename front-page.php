...
<section id="ee-products" aria-label="Our products">
  ...
  (function(){
    ...
    var P = [
      ...
      {id:'ams', t:'Admission Management', cat:'admissions', ic:'shield', href:'/admission-management-software/',
      ...
      {id:'app-mgmt', t:'Application Management', cat:'admissions', ic:'doc', href:'/products/application-management-system/',
      ...
      {id:'chatbot', t:'AI Chatbot', badge:'New', cat:'ai', ic:'chat', href:'/products/chatbot-for-education/',
      ...
      {id:'mkt-auto', t:'Marketing Automation', cat:'grow', ic:'send', href:'/products/',
      ...
      {id:'mob-crm', t:'Mobile CRM', cat:'platform', ic:'phone', href:'/products/mobile-crm/',
      ...
      {id:'analytics', t:'Analytics & Reporting', cat:'grow', ic:'bars', href:'/products/',
