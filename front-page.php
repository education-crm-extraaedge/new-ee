...
@media (max-width:640px){
  ...
  /* S3 reasoning */
  .s3-grid{grid-template-columns:1fr!important;gap:20px!important;max-width:420px}
  ...
  .case{grid-template-columns:1fr!important;gap:16px!important;max-width:420px}
  ...
  .metrics{grid-template-columns:repeat(2,1fr)!important;max-width:360px;gap:12px}
