...
<style>
  ...
  @media(max-width:768px){
    ...
    #vidya-film .hero-film__frame{aspect-ratio:4/3;width:100%}
  }
</style>
...
function fitStage(){
  ...
  // <=768px (phones/tablets): COVER the frame so the perfectly-rendered canvas
  //   reads large (slight side crop). >768px: CONTAIN (fit fully, no crop).
  const s = vw<=768 ? Math.max(vw/STAGE_W, vh/STAGE_H)
