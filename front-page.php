...
#xhero h1{font-family:var(--font);font-weight:800;font-size:clamp(40px,4.8vw,66px);line-height:1.05;letter-spacing:-.035em;margin:26px 0 0;color:var(--navy)}
...
#xhero .float--score{top:-34px;right:-22px;display:flex;align-items:center;gap:12px}
...
#xhero .float--conv{bottom:-30px;left:-26px;animation-delay:1.4s}
...
.day{align-self:center;background:#fff;border:1px solid #e7eef6;color:var(--vg-navy);font-size:11px;font-weight:700;padding:4px 14px;border-radius:999px;box-shadow:0 4px 12px rgba(27,55,97,.06);margin-bottom:14px}
