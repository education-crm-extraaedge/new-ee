...
@media (max-width:900px){
  ...
  .verdict{min-width:0!important;width:100%;max-width:230px;padding:16px;margin:0 auto!important}
  ...
  .metric:last-child{grid-column:1/-1;justify-self:center;width:48%}
  .ecosystem{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;width:100%!important;max-width:320px;height:auto!important;aspect-ratio:auto!important}
  .eco-ring{display:none!important}
  .eco-core{grid-column:1/-1;justify-self:center;width:80px;height:80px;margin:0 auto 6px}
  .eco-core b{font-size:14px}.eco-core small{font-size:8px}
  .mod{position:static!important;transform:none!important;left:auto!important;top:auto!important;opacity:1!important;animation:none!important;justify-content:center;font-size:9.5px;padding:6px 8px}
