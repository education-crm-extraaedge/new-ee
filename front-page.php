...
<section class="logo-section" id="trusted-institutions" aria-label="Trusted Institutions">
  <div class="logo-header reveal">
    ...
    <div class="logo-stats" style="display:flex;flex-wrap:wrap;justify-content:center;gap:clamp(20px,5vw,56px);margin-bottom:6px">
      <div style="text-align:center"><div style="font-family:var(--font-h);font-weight:800;font-size:clamp(1.6rem,3.4vw,2.4rem);color:#DE6E30;line-height:1">500+</div><div style="font-size:.8rem;font-weight:600;color:#7A879E;text-transform:uppercase;letter-spacing:.06em">Institutions</div></div>
      <div style="text-align:center"><div style="font-family:var(--font-h);font-weight:800;font-size:clamp(1.6rem,3.4vw,2.4rem);color:#DE6E30;line-height:1">5M+</div><div style="font-size:.8rem;font-weight:600;color:#7A879E;text-transform:uppercase;letter-spacing:.06em">Student Leads</div></div>
      <div style="text-align:center"><div style="font-family:var(--font-h);font-weight:800;font-size:clamp(1.6rem,3.4vw,2.4rem);color:#DE6E30;line-height:1">100M+</div><div style="font-size:.8rem;font-weight:600;color:#7A879E;text-transform:uppercase;letter-spacing:.06em">Interactions</div></div>
    </div>
  </div>
  ...
  <div style="text-align:center;margin-top:26px">
    <a href="#demo" style="display:inline-flex;align-items:center;gap:8px;font-weight:700;font-size:.95rem;color:#19335D;border:1.5px solid rgba(25,51,93,.18);background:#fff;border-radius:999px;padding:11px 24px;text-decoration:none;transition:all .2s ease" onmouseover="this.style.borderColor='#DE6E30';this.style.color='#DE6E30'" onmouseout="this.style.borderColor='rgba(25,51,93,.18)';this.style.color='#19335D'">View More Clients <span aria-hidden="true">&rarr;</span></a>
  </div>
</section>
...
<style>
  #ee-vidya-suite{
    --vn:#19335D; --vn2:#122548; --or:#DE6E30; --or2:#E8843F;
    --cy:#22D3EE; --vi:#A78BFA; --gr:#34D399; --go:#FBBF24;
    position:relative; background:transparent;
    font-family:'Inter',system-ui,-apple-system,sans-serif;
    color:#EAF0FA; -webkit-font-smoothing:antialiased;
  }
  #ee-vidya-suite *{box-sizing:border-box;}

  /* ---- track + sticky pin ---- */
  #ee-vidya-suite .vsx-track{ position:relative; }
  #ee-vidya-suite .vsx-sticky{
    position:relative;
    border-radius:28px; overflow:hidden;
    margin:clamp(20px,3vw,40px) auto; max-width:1280px;
    background:radial-gradient(120% 120% at 85% -10%, #21407a 0%, var(--vn) 42%, var(--vn2) 100%);
    border:1px solid rgba(255,255,255,.08);
    box-shadow:0 40px 90px -40px rgba(8,18,42,.8), inset 0 1px 0 rgba(255,255,255,.06);
  ...
  #ee-vidya-suite .vsx-bg{ position:absolute; inset:0; z-index:0; pointer-events:none;
    background:radial-gradient(640px 360px at 88% 6%, rgba(222,110,48,.22), transparent 60%),
              radial-gradient(560px 360px at 6% 96%, rgba(34,211,238,.16), transparent 62%);
  }
  #ee-vidya-suite .vsx-bg::after{ content:""; position:absolute; inset:0; opacity:.5;
    background-image:linear-gradient(rgba(255,255,255,.03) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.03) 1px,transparent 1px);
    background-size:34px 34px; -webkit-mask-image:radial-gradient(620px 420px at 80% 0%,#000,transparent 75%); mask-image:radial-gradient(620px 420px at 80% 0%,#000,transparent 75%); }
  #ee-vidya-suite .vsx-inner{ position:relative; z-index:1; }

  /* ---- header ---- */
  #ee-vidya-suite .vsx-eyebrow{ display:inline-flex; align-items:center; gap:9px; padding:7px 14px 7px 11px; border-radius:999px;
    background:rgba(34,211,238,.1); border:1px solid rgba(34,211,238,.28); color:#bdf2fb;
    font-size:11.5px; font-weight:700; letter-spacing:.14em; text-transform:uppercase; margin-bottom:16px; }
  #ee-vidya-suite .vsx-eyebrow i{ width:7px; height:7px; border-radius:50%; background:var(--cy); box-shadow:0 0 0 4px rgba(34,211,238,.18); animation:vsxBlink 1.8s ease-in-out infinite; }
  @keyframes vsxBlink{ 0%,100%{opacity:1} 50%{opacity:.3} }
  #ee-vidya-suite h2{ font-family:'Poppins','Inter',sans-serif; font-weight:700; color:#fff;
    font-size:clamp(23px,3.3vw,40px); line-height:1.1; letter-spacing:-.02em; margin:0 0 12px; max-width:18ch; }
  #ee-vidya-suite .vsx-lead{ font-size:clamp(14px,1.6vw,16.5px); line-height:1.6; color:#c2cfe4; margin:0; max-width:62ch; }
  ...
  @media (max-width:900px){
    #ee-vidya-suite .vsx-sticky{ border-radius:22px; }
  }
  @media (prefers-reduced-motion:reduce){
    #ee-vidya-suite *{ animation:none !important; }
  }
</style>
...
<style>
  ...
  #ee-teams * { box-sizing: border-box; }
  #ee-teams .ee-teams-container {
    max-width: 1240px;
    margin: 0 auto;
    padding: 0 24px;
  }
  ...
  #ee-teams .ee-card {
    ...
    box-shadow: 0 1px 2px rgba(15, 31, 58, .04), 0 10px 24px -16px rgba(15, 31, 58, .22);
  ...
  #ee-teams a.ee-card:hover,
  #ee-teams a.ee-card:focus-visible {
    transform: translateY(-4px);
    box-shadow: 0 1px 2px rgba(15, 31, 58, .05), 0 22px 40px -22px rgba(25, 51, 93, .35);
    border-color: rgba(25, 51, 93, .16);
  }
  #ee-teams a.ee-card:hover::before,
  #ee-teams a.ee-card:focus-visible::before {
    transform: scaleX(1);
  }
  #ee-teams a.ee-card:focus-visible {
  ...
  #ee-teams .ee-chip {
    ...
    font-size: 24px;
    line-height: 1;
    background: linear-gradient(160deg, rgba(34, 70, 124, .10), rgba(25, 51, 93, .05));
    border: 1px solid rgba(25, 51, 93, .10);
  }
  ...
  #ee-teams a.ee-card:hover .ee-card-arrow,
  #ee-teams a.ee-card:focus-visible .ee-card-arrow {
    opacity: 1;
    transform: translateY(0);
  }
  #ee-teams .ee-card-arrow svg { display: block; }
  ...
  @media (prefers-reduced-motion: reduce) {
    #ee-teams .ee-card,
    #ee-teams .ee-card::before,
    #ee-teams .ee-card-arrow { transition: none; }
  }
</style>
...
<style>
  ...
  #ee-industries .eir-wrap{max-width:1180px;margin:0 auto;padding:0 24px;}

  /* ---------- Header ---------- */
  #ee-industries .eir-head{max-width:720px;margin:0 auto clamp(34px,4.5vw,46px);text-align:center;}
  #ee-industries .eir-eyebrow{
  ...
  #ee-industries .eir-eyebrow .eir-dot{width:7px;height:7px;border-radius:50%;background:var(--orange);box-shadow:0 0 0 4px rgba(222,110,48,.16);}
  #ee-industries h2{
  ...
  #ee-industries .eir-sub{font-size:clamp(15px,1.7vw,18px);line-height:1.55;color:var(--muted);margin:0;}

  /* ---------- Stage card (dark, cinematic) ---------- */
  #ee-industries .eir-stage{
  ...
  /* progress segments */
  #ee-industries .eir-segs{
    display:flex;align-items:center;gap:6px;
    padding:16px clamp(18px,3vw,30px) 0;
  }
  #ee-industries .eir-seg{
    position:relative;flex:1;height:4px;border-radius:99px;border:0;padding:0;cursor:pointer;
    background:rgba(255,255,255,.16);overflow:hidden;
  }
  #ee-industries .eir-seg-fill{position:absolute;inset:0;width:0;background:linear-gradient(90deg,var(--orange-lt),var(--orange));border-radius:99px;}
  #ee-industries .eir-seg.done .eir-seg-fill,
  #ee-industries .eir-seg.cur  .eir-seg-fill{width:100%;}
  #ee-industries .eir-seg.active .eir-seg-fill{animation:eeFill var(--dur) linear forwards;}
  #ee-industries.paused .eir-seg.active .eir-seg-fill{animation-play-state:paused;}
  @keyframes eeFill{from{width:0}to{width:100%}}
  #ee-industries .eir-seg:focus-visible{outline:2px solid var(--orange);outline-offset:3px;}

  #ee-industries .eir-playpause{
    flex:0 0 auto;width:30px;height:30px;margin-left:6px;border-radius:50%;cursor:pointer;
    background:rgba(255,255,255,.10);border:1px solid rgba(255,255,255,.16);
    display:inline-flex;align-items:center;justify-content:center;color:#fff;
    transition:background .2s;
  }
  #ee-industries .eir-playpause:hover{background:rgba(255,255,255,.2);}
  #ee-industries .eir-playpause svg{width:13px;height:13px;}
  #ee-industries .eir-playpause .eir-ic-pause{display:none;}
  #ee-industries:not(.paused) .eir-playpause .eir-ic-pause{display:block;}
  #ee-industries:not(.paused) .eir-playpause .eir-ic-play{display:none;}

  /* layout: rail + panel */
  #ee-industries .eir-grid{
    display:grid;grid-template-columns:236px 1fr;gap:0;
    padding:18px clamp(18px,3vw,30px) clamp(24px,3vw,32px);
  }

  /* chapter rail */
  #ee-industries .eir-rail{display:flex;flex-direction:column;gap:2px;padding-right:18px;border-right:1px solid rgba(255,255,255,.08);}
  #ee-industries .eir-chap{
  ...
  #ee-industries .eir-chap-ic{flex:0 0 auto;width:20px;height:20px;color:#6f86a8;transition:color .2s,transform .2s;}
  #ee-industries .eir-chap-ic svg{width:20px;height:20px;display:block;}
  #ee-industries .eir-chap:hover{color:#e6eefb;background:rgba(255,255,255,.04);}
  #ee-industries .eir-chap:hover .eir-chap-ic{color:#9fb2cf;}
  #ee-industries .eir-chap[aria-selected="true"]{color:#fff;background:rgba(255,255,255,.06);}
  #ee-industries .eir-chap[aria-selected="true"] .eir-chap-ic{color:var(--orange-lt);transform:scale(1.05);}
  #ee-industries .eir-chap[aria-selected="true"]::before{
  ...
  #ee-industries .eir-chap:focus-visible{outline:2px solid var(--orange);outline-offset:2px;}

  /* story panel */
  #ee-industries .eir-panel{position:relative;padding-left:clamp(18px,2.6vw,34px);min-height:300px;}
  #ee-industries .eir-slide{display:none;}
  #ee-industries .eir-slide.is-active{display:block;animation:eeRise .5s cubic-bezier(.2,.7,.3,1) both;}
  @keyframes eeRise{from{opacity:0;transform:translateY(14px)}to{opacity:1;transform:none}}

  #ee-industries .eir-slide-head{display:flex;align-items:flex-start;gap:16px;margin-bottom:22px;}
  #ee-industries .eir-ind-icon{
  ...
  #ee-industries .eir-ind-icon svg{width:27px;height:27px;}
  #ee-industries .eir-kicker{display:block;font-family:'Poppins','Inter',sans-serif;font-size:clamp(20px,2.4vw,26px);font-weight:700;color:#fff;letter-spacing:-.01em;line-height:1.15;}
  #ee-industries .eir-scene{margin:6px 0 0;font-size:clamp(14px,1.7vw,16px);line-height:1.5;color:#cdd9ee;font-style:italic;}

  #ee-industries .eir-beats{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:22px;}
  #ee-industries .eir-beat{
    padding:15px 16px;border-radius:13px;background:rgba(255,255,255,.045);border:1px solid rgba(255,255,255,.08);
  }
  #ee-industries .eir-beat-sol{background:rgba(222,110,48,.12);border-color:rgba(222,110,48,.28);}
  #ee-industries .eir-beat-label{
  ...
  #ee-industries .eir-beat-sol .eir-beat-label{color:var(--orange-lt);}
  #ee-industries .eir-beat-label::before{content:"";width:6px;height:6px;border-radius:50%;background:currentColor;}
  #ee-industries .eir-beat p{margin:0;font-size:13.5px;line-height:1.5;color:#d6e0f1;}

  #ee-industries .eir-slide-foot{display:flex;flex-wrap:wrap;align-items:center;gap:14px 18px;}
  #ee-industries .eir-outcome{
  ...
  #ee-industries .eir-outcome::before{
  ...
  #ee-industries .eir-slide-cta:hover{color:#fff;gap:10px;}
  #ee-industries .eir-slide-cta svg{width:15px;height:15px;}

  /* prev / next */
  #ee-industries .eir-nav{position:absolute;right:0;bottom:0;display:flex;gap:8px;}
  #ee-industries .eir-nav button{
  ...
  #ee-industries .eir-nav button:hover{background:rgba(255,255,255,.18);color:#fff;}
  #ee-industries .eir-nav button:focus-visible{outline:2px solid var(--orange);outline-offset:2px;}
  #ee-industries .eir-nav svg{width:15px;height:15px;}

  /* ---------- Responsive ---------- */
  @media(max-width:840px){
    #ee-industries .eir-grid{grid-template-columns:1fr;padding-top:14px;}
    #ee-industries .eir-rail{
    ...
    #ee-industries .eir-chap{flex:0 0 auto;white-space:nowrap;}
    #ee-industries .eir-chap[aria-selected="true"]::before{display:none;}
    #ee-industries .eir-panel{padding-left:0;min-height:0;}
    #ee-industries .eir-beats{grid-template-columns:1fr;}
    #ee-industries .eir-nav{position:static;justify-content:flex-end;margin-top:18px;}
  }
  @media(prefers-reduced-motion:reduce){
    #ee-industries *{animation:none !important;}
    #ee-industries .eir-seg.active .eir-seg-fill{width:100%;}
  }
</style>

<!-- icon sprite (defined once) -->
<svg width="0" height="0" style="position:absolute" aria-hidden="true" focusable="false"><defs>
  <symbol id="eir-i-edtech" viewBox="0 0 24 24">
  ...
  <symbol id="eir-i-coaching" viewBox="0 0 24 24">
  ...
  <symbol id="eir-i-k12" viewBox="0 0 24 24">
  ...
  <symbol id="eir-i-preschool" viewBox="0 0 24 24">
  ...
  <symbol id="eir-i-online" viewBox="0 0 24 24">
  ...
  <symbol id="eir-i-higher" viewBox="0 0 24 24">
  ...
  <symbol id="eir-i-abroad" viewBox="0 0 24 24">
  ...
  <symbol id="eir-i-channel" viewBox="0 0 24 24">
...
<section id="ee-industries" aria-label="Industries we serve">
  <div class="eir-wrap">
    ...
    <div class="eir-head">
      <span class="eir-eyebrow"><span class="eir-dot" aria-hidden="true"></span>Industries</span>
      <h2>Built for every kind of institution</h2>
      <p class="eir-sub">One AI-powered admissions platform, tuned to the way your category recruits, nurtures and enrols students. Press play and see your story.</p>
    </div>

    <div class="eir-stage">

      <!-- progress segments -->
      <div class="eir-segs" id="eeSegs" aria-hidden="true"></div>

      <div class="eir-grid">

        <!-- chapter rail -->
        <div class="eir-rail" role="tablist" aria-label="Choose an industry">
          <button class="eir-chap" role="tab" data-i="0" aria-selected="true"><span class="eir-chap-ic"><svg><use href="#eir-i-edtech"/></svg></span><span class="eir-chap-name">EdTech</span></button>
          <button class="eir-chap" role="tab" data-i="1" aria-selected="false"><span class="eir-chap-ic"><svg><use href="#eir-i-coaching"/></svg></span><span class="eir-chap-name">Coaching &amp; Training Institutes</span></button>
          <button class="eir-chap" role="tab" data-i="2" aria-selected="false"><span class="eir-chap-ic"><svg><use href="#eir-i-k12"/></svg></span><span class="eir-chap-name">K-12 Schools</span></button>
          <button class="eir-chap" role="tab" data-i="3" aria-selected="false"><span class="eir-chap-ic"><svg><use href="#eir-i-preschool"/></svg></span><span class="eir-chap-name">Preschools &amp; Playschools</span></button>
          <button class="eir-chap" role="tab" data-i="4" aria-selected="false"><span class="eir-chap-ic"><svg><use href="#eir-i-online"/></svg></span><span class="eir-chap-name">Online Degree Programmes</span></button>
          <button class="eir-chap" role="tab" data-i="5" aria-selected="false"><span class="eir-chap-ic"><svg><use href="#eir-i-higher"/></svg></span><span class="eir-chap-name">Higher Education</span></button>
          <button class="eir-chap" role="tab" data-i="6" aria-selected="false"><span class="eir-chap-ic"><svg><use href="#eir-i-abroad"/></svg></span><span class="eir-chap-name">Study Abroad Consultants</span></button>
          <button class="eir-chap" role="tab" data-i="7" aria-selected="false"><span class="eir-chap-ic"><svg><use href="#eir-i-channel"/></svg></span><span class="eir-chap-name">Channel Partners</span></button>
        </div>

        <!-- story panel -->
        <div class="eir-panel" role="tabpanel" aria-live="polite">

          <article class="eir-slide is-active" data-i="0">
            <div class="eir-slide-head">
              <span class="eir-ind-icon"><svg><use href="#eir-i-edtech"/></svg></span>
              <div><span class="eir-kicker">EdTech</span><p class="eir-scene">You buy leads by the thousand — and they cool in minutes.</p></div>
            </div>
            <div class="eir-beats">
              <div class="eir-beat"><span class="eir-beat-label">The challenge</span><p>Manual follow-up can't keep pace. Paid leads go cold before a counsellor ever calls.</p></div>
              <div class="eir-beat eir-beat-sol"><span class="eir-beat-label">With ExtraaEdge</span><p>Vidya Call rings every new lead in seconds, AI reads intent, and hot leads route straight to a counsellor.</p></div>
            </div>
            <div class="eir-slide-foot"><span class="eir-outcome">First response in seconds, not days</span><a class="eir-slide-cta" href="#demo">See it for EdTech <svg viewBox="0 0 24 24" fill="none"><path d="M5 12h13M13 6l6 6-6 6" stroke="currentColor" stroke-width="1.8"/></svg></a></div>
          </article>

          <article class="eir-slide" data-i="1">
            <div class="eir-slide-head">
              <span class="eir-ind-icon"><svg><use href="#eir-i-coaching"/></svg></span>
              <div><span class="eir-kicker">Coaching &amp; Training Institutes</span><p class="eir-scene">Batches fill on deadlines — every enquiry is a seat.</p></div>
            </div>
            <div class="eir-beats">
              <div class="eir-beat"><span class="eir-beat-label">The challenge</span><p>The front desk juggles calls, WhatsApp and walk-ins. Follow-ups slip and seats stay empty.</p></div>
              <div class="eir-beat eir-beat-sol"><span class="eir-beat-label">With ExtraaEdge</span><p>One inbox for calls, WhatsApp and forms, with auto-nurture that keeps every enquiry warm until the batch starts.</p></div>
            </div>
            <div class="eir-slide-foot"><span class="eir-outcome">Every seat tracked to enrolment</span><a class="eir-slide-cta" href="#demo">See it for Coaching <svg viewBox="0 0 24 24" fill="none"><path d="M5 12h13M13 6l6 6-6 6" stroke="currentColor" stroke-width="1.8"/></svg></a></div>
          </article>

          <article class="eir-slide" data-i="2">
            <div class="eir-slide-head">
              <span class="eir-ind-icon"><svg><use href="#eir-i-k12"/></svg></span>
              <div><span class="eir-kicker">K-12 Schools</span><p class="eir-scene">Parents take months to choose — trust wins the seat.</p></div>
            </div>
            <div class="eir-beats">
              <div class="eir-beat"><span class="eir-beat-label">The challenge</span><p>Enquiries span the whole admission season. Manual nurture loses families along the way.</p></div>
              <div class="eir-beat eir-beat-sol"><span class="eir-beat-label">With ExtraaEdge</span><p>Personalised drips, school-tour reminders and gentle fee nudges keep families warm right up to the deadline.</p></div>
            </div>
            <div class="eir-slide-foot"><span class="eir-outcome">Nurtured from enquiry to fee paid</span><a class="eir-slide-cta" href="#demo">See it for K-12 <svg viewBox="0 0 24 24" fill="none"><path d="M5 12h13M13 6l6 6-6 6" stroke="currentColor" stroke-width="1.8"/></svg></a></div>
          </article>

          <article class="eir-slide" data-i="3">
            <div class="eir-slide-head">
              <span class="eir-ind-icon"><svg><use href="#eir-i-preschool"/></svg></span>
              <div><span class="eir-kicker">Preschools &amp; Playschools</span><p class="eir-scene">It's their first school — parents want reassurance, fast.</p></div>
            </div>
            <div class="eir-beats">
              <div class="eir-beat"><span class="eir-beat-label">The challenge</span><p>Small teams, anxious parents. Every missed call is a lost admission.</p></div>
              <div class="eir-beat eir-beat-sol"><span class="eir-beat-label">With ExtraaEdge</span><p>WhatsApp and IVR catch every enquiry, and instant answers calm parents before they call the school next door.</p></div>
            </div>
            <div class="eir-slide-foot"><span class="eir-outcome">No enquiry rings out unanswered</span><a class="eir-slide-cta" href="#demo">See it for Preschools <svg viewBox="0 0 24 24" fill="none"><path d="M5 12h13M13 6l6 6-6 6" stroke="currentColor" stroke-width="1.8"/></svg></a></div>
          </article>

          <article class="eir-slide" data-i="4">
            <div class="eir-slide-head">
              <span class="eir-ind-icon"><svg><use href="#eir-i-online"/></svg></span>
              <div><span class="eir-kicker">Online Degree Programmes</span><p class="eir-scene">You compete nationally for every learner — online.</p></div>
            </div>
            <div class="eir-beats">
              <div class="eir-beat"><span class="eir-beat-label">The challenge</span><p>Thousands of enquiries, a wide funnel, and no easy way to spot who's ready to enrol.</p></div>
              <div class="eir-beat eir-beat-sol"><span class="eir-beat-label">With ExtraaEdge</span><p>AI scores intent and predicts who'll convert, while applicants apply and pay fully online.</p></div>
            </div>
            <div class="eir-slide-foot"><span class="eir-outcome">Apply and pay, fully online</span><a class="eir-slide-cta" href="#demo">See it for Online Degrees <svg viewBox="0 0 24 24" fill="none"><path d="M5 12h13M13 6l6 6-6 6" stroke="currentColor" stroke-width="1.8"/></svg></a></div>
          </article>

          <article class="eir-slide" data-i="5">
            <div class="eir-slide-head">
              <span class="eir-ind-icon"><svg><use href="#eir-i-higher"/></svg></span>
              <div><span class="eir-kicker">Higher Education</span><p class="eir-scene">Many programmes, many counsellors, one admission season.</p></div>
            </div>
            <div class="eir-beats">
              <div class="eir-beat"><span class="eir-beat-label">The challenge</span><p>Pipelines fragment across departments and campuses, and leadership loses visibility.</p></div>
              <div class="eir-beat eir-beat-sol"><span class="eir-beat-label">With ExtraaEdge</span><p>One CRM unifies every programme and campus, with real-time dashboards for the people who answer for the numbers.</p></div>
            </div>
            <div class="eir-slide-foot"><span class="eir-outcome">Every programme on one live dashboard</span><a class="eir-slide-cta" href="#demo">See it for Higher Ed <svg viewBox="0 0 24 24" fill="none"><path d="M5 12h13M13 6l6 6-6 6" stroke="currentColor" stroke-width="1.8"/></svg></a></div>
          </article>

          <article class="eir-slide" data-i="6">
            <div class="eir-slide-head">
              <span class="eir-ind-icon"><svg><use href="#eir-i-abroad"/></svg></span>
              <div><span class="eir-kicker">Study Abroad Consultants</span><p class="eir-scene">A single student journey can run for a year.</p></div>
            </div>
            <div class="eir-beats">
              <div class="eir-beat"><span class="eir-beat-label">The challenge</span><p>Stages, documents and follow-ups stretch across countries and intakes — and high-value leads slip.</p></div>
              <div class="eir-beat eir-beat-sol"><span class="eir-beat-label">With ExtraaEdge</span><p>Track every stage, automate document nudges, and never drop a lead worth lakhs in fees.</p></div>
            </div>
            <div class="eir-slide-foot"><span class="eir-outcome">Every stage and document on track</span><a class="eir-slide-cta" href="#demo">See it for Study Abroad <svg viewBox="0 0 24 24" fill="none"><path d="M5 12h13M13 6l6 6-6 6" stroke="currentColor" stroke-width="1.8"/></svg></a></div>
          </article>

          <article class="eir-slide" data-i="7">
            <div class="eir-slide-head">
              <span class="eir-ind-icon"><svg><use href="#eir-i-channel"/></svg></span>
              <div><span class="eir-kicker">Channel Partners</span><p class="eir-scene">Your partners send leads — you need to see every one.</p></div>
            </div>
            <div class="eir-beats">
              <div class="eir-beat"><span class="eir-beat-label">The challenge</span><p>Leads leak across the partner network, and no one can prove which source actually delivered.</p></div>
              <div class="eir-beat eir-beat-sol"><span class="eir-beat-label">With ExtraaEdge</span><p>Capture every partner lead with full source attribution and track each one all the way to enrolment.</p></div>
            </div>
            <div class="eir-slide-foot"><span class="eir-outcome">Full visibility, zero lead leakage</span><a class="eir-slide-cta" href="#demo">See it for Partners <svg viewBox="0 0 24 24" fill="none"><path d="M5 12h13M13 6l6 6-6 6" stroke="currentColor" stroke-width="1.8"/></svg></a></div>
          </article>
  ...
  (function(){
    ...
    if(!root) return;
    var rail   = root.querySelectorAll('.eir-chap');
    var slides = root.querySelectorAll('.eir-slide');
    ...
    var segs=[];
    var names = Array.prototype.map.call(rail, function(c){ return c.querySelector('.eir-chap-name').textContent; });
    for(var i=0;i<N;i++){
      var s=document.createElement('button');
      s.className='eir-seg'; s.type='button'; s.setAttribute('data-i',i);
      s.setAttribute('aria-label','Show '+names[i]);
      s.innerHTML='<span class="eir-seg-fill"></span>';
      segWrap.appendChild(s); segs.push(s);
    }
    var pp=document.createElement('button');
    pp.className='eir-playpause'; pp.type='button'; pp.setAttribute('aria-label','Pause');
    pp.innerHTML='<svg class="eir-ic-pause" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg>'
               +'<svg class="eir-ic-play" viewBox="0 0 24 24" fill="currentColor"><path d="M7 5l12 7-12 7z"/></svg>';
    ...
    function go(i, fromAuto){
      ...
      var c0=segs[cur], f=c0.querySelector('.eir-seg-fill');
      void f.offsetWidth;
    ...
    segs.forEach(function(seg){
      seg.querySelector('.eir-seg-fill').addEventListener('animationend', function(){
    ...
    root.querySelector('.eir-rail').addEventListener('keydown', function(e){
...
<style>
  #ee-resources{
    --navy:#19335D; --navy2:#22467c; --orange:#DE6E30; --orange2:#E8843F;
    --ink:#0F1F3A; --muted:#5A6B85; --hair:rgba(25,51,93,.09);
    position:relative; padding:clamp(64px,8vw,104px) 0;
    font-family:'Inter',system-ui,-apple-system,Segoe UI,Roboto,sans-serif;
    color:var(--ink); background:transparent;
  }
  #ee-resources *{box-sizing:border-box;}
  #ee-resources .ee-r-container{max-width:1240px;margin:0 auto;padding:0 24px;}
  #ee-resources .ee-r-head{max-width:760px;margin:0 0 clamp(32px,4vw,48px);}
  ...
  #ee-resources .ee-r-card{
    ...
    background:#fff;border:1px solid var(--hair);border-radius:16px;
    padding:24px 22px 22px;text-decoration:none;color:inherit;
    box-shadow:0 1px 2px rgba(15,31,58,.04),0 8px 24px -16px rgba(15,31,58,.18);
  ...
  #ee-resources .ee-r-card:hover{
    transform:translateY(-6px);border-color:rgba(25,51,93,.16);
    box-shadow:0 2px 4px rgba(15,31,58,.05),0 22px 40px -22px rgba(25,51,93,.32);
  }
  #ee-resources .ee-r-card:hover::after{transform:scaleX(1);}
  #ee-resources .ee-r-card:focus-visible{
  ...
  #ee-resources .ee-r-ico svg{width:23px;height:23px;display:block;}
  #ee-resources .ee-r-title{
    font-family:'Poppins','Inter',system-ui,sans-serif;
  ...
  #ee-resources .ee-r-link svg{width:14px;height:14px;transition:transform .25s ease;}
  #ee-resources .ee-r-card:hover .ee-r-link svg{transform:translateX(4px);}

  @media (max-width:900px){
    #ee-resources .ee-r-grid{grid-template-columns:repeat(2,minmax(0,1fr));}
  }
  @media (max-width:560px){
    #ee-resources .ee-r-grid{grid-template-columns:1fr;gap:14px;}
    #ee-resources .ee-r-container{padding:0 18px;}
  }
  @media (prefers-reduced-motion:reduce){
    #ee-resources .ee-r-card,#ee-resources .ee-r-card::after,
    #ee-resources .ee-r-ico,#ee-resources .ee-r-link svg{transition:none;}
  }
</style>
    ...
    <div class="ee-r-grid">
      ...
      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H20v15.5H6.5A2.5 2.5 0 0 0 4 21z"/><path d="M4 18.5A2.5 2.5 0 0 1 6.5 16H20"/></svg>
        </span>
        ...
        <span class="ee-r-link">Explore <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span>
      </a>

      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3h9l5 5v13H6z"/><path d="M15 3v5h5"/><path d="M9.5 13.5l2 2 3.5-4"/></svg>
        </span>
      ...
      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19h16"/><path d="M5 16l4-4 3 3 6-7"/><path d="M18 8h3v3"/></svg>
        </span>
      ...
      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M5 4v16l7-4 7 4V4z"/><path d="M9 9h6M9 12h4"/></svg>
        </span>
      ...
      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M8 7h8"/><path d="M8 11h3M13 11h3M8 15h3M13 15h3"/></svg>
        </span>
      ...
      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="13" rx="2"/><path d="M12 17v4M8 21h8"/><path d="M9 8l4 2.5L9 13z" fill="currentColor" stroke="none"/></svg>
        </span>
      ...
      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M7 18v-3a5 5 0 0 1 10 0v3"/><path d="M5 21h14"/><circle cx="12" cy="6" r="3"/><path d="M9 21v-2M15 21v-2"/></svg>
        </span>
      ...
      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M10 9l5 3-5 3z" fill="currentColor" stroke="none"/></svg>
        </span>
      ...
      <a class="ee-r-card" href="#demo">
        <span class="ee-r-ico" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 9h18M8 3v4M16 3v4"/><path d="M7.5 13h2v2h-2z" fill="currentColor" stroke="none"/></svg>
        </span>
...
<style>
  ...
  #ee-events *{box-sizing:border-box;}
  #ee-events .ee-e-container{max-width:1240px;margin:0 auto;padding:0 24px;}
  #ee-events .ee-e-head{max-width:760px;margin:0 0 clamp(32px,4vw,48px);}
  #ee-events .ee-e-eyebrow{
    display:inline-flex;align-items:center;gap:8px;
    font-size:12px;font-weight:600;letter-spacing:.14em;text-transform:uppercase;
    color:var(--orange);margin:0 0 16px;
  }
  ...
  #ee-events .ee-e-grid{
    display:grid;gap:20px;margin-bottom:clamp(40px,5vw,56px);
  ...
  #ee-events .ee-e-card{
    ...
    box-shadow:0 1px 2px rgba(15,31,58,.04),0 10px 28px -18px rgba(15,31,58,.22);
    transition:transform .28s cubic-bezier(.2,.7,.3,1),box-shadow .28s ease,border-color .28s ease;
  }
  #ee-events .ee-e-card:hover{
    transform:translateY(-6px);border-color:rgba(25,51,93,.16);
    box-shadow:0 2px 4px rgba(15,31,58,.05),0 24px 44px -22px rgba(25,51,93,.34);
  }
  #ee-events .ee-e-card:focus-within{outline:3px solid rgba(222,110,48,.4);outline-offset:3px;}
  #ee-events .ee-e-top{display:flex;align-items:center;gap:12px;margin-bottom:18px;}
  #ee-events .ee-e-date{
    ...
    box-shadow:0 8px 18px -10px rgba(25,51,93,.6);
  }
  #ee-events .ee-e-date .d{font-family:'Poppins','Inter',sans-serif;font-weight:600;font-size:22px;}
  #ee-events .ee-e-date .m{font-size:10.5px;font-weight:600;letter-spacing:.12em;text-transform:uppercase;margin-top:4px;opacity:.92;}
  #ee-events .ee-e-date .y{font-size:10px;font-weight:500;margin-top:3px;opacity:.7;}
  #ee-events .ee-e-tag{
  ...
  #ee-events .ee-e-tag.is-live{color:var(--orange);background:rgba(222,110,48,.10);border-color:rgba(222,110,48,.18);}
  #ee-events .ee-e-tag .dot{width:6px;height:6px;border-radius:50%;background:currentColor;}
  #ee-events .ee-e-title{
    font-family:'Poppins','Inter',system-ui,sans-serif;
    font-weight:600;font-size:18px;line-height:1.28;margin:0 0 9px;color:var(--navy);
  }
  #ee-events .ee-e-desc{margin:0 0 20px;font-size:14px;line-height:1.55;color:var(--muted);}
  #ee-events .ee-e-link{
    margin-top:auto;display:inline-flex;align-items:center;gap:6px;
    font-size:13.5px;font-weight:600;color:var(--orange);
  }
  #ee-events .ee-e-link svg{width:14px;height:14px;transition:transform .25s ease;}
  #ee-events .ee-e-card:hover .ee-e-link svg{transform:translateX(4px);}
  #ee-events .ee-e-link:focus-visible{outline:3px solid rgba(222,110,48,.55);outline-offset:3px;border-radius:4px;}

  #ee-events .ee-e-odhead{
    display:flex;align-items:baseline;gap:12px;margin:0 0 18px;
    font-family:'Poppins','Inter',sans-serif;font-weight:600;font-size:15px;color:var(--navy);
  }
  ...
  #ee-events .ee-e-od{
    ...
    box-shadow:0 1px 2px rgba(15,31,58,.04),0 8px 22px -16px rgba(15,31,58,.2);
    transition:transform .26s cubic-bezier(.2,.7,.3,1),box-shadow .26s ease,border-color .26s ease;
  }
  #ee-events .ee-e-od:hover{transform:translateY(-4px);border-color:rgba(25,51,93,.16);box-shadow:0 2px 4px rgba(15,31,58,.05),0 18px 34px -20px rgba(25,51,93,.3);}
  #ee-events .ee-e-od:focus-visible{outline:3px solid rgba(222,110,48,.55);outline-offset:3px;}
  #ee-events .ee-e-play{
  ...
  #ee-events .ee-e-play svg{width:16px;height:16px;margin-left:2px;}
  #ee-events .ee-e-od-body{display:flex;flex-direction:column;gap:5px;min-width:0;}
  #ee-events .ee-e-od-title{font-family:'Poppins','Inter',sans-serif;font-weight:600;font-size:14.5px;line-height:1.25;color:var(--navy);}
  #ee-events .ee-e-od-link{display:inline-flex;align-items:center;gap:5px;font-size:12.5px;font-weight:600;color:var(--orange);}
  #ee-events .ee-e-od-link svg{width:12px;height:12px;transition:transform .25s ease;}
  #ee-events .ee-e-od:hover .ee-e-od-link svg{transform:translateX(3px);}

  @media (max-width:900px){
    #ee-events .ee-e-grid{grid-template-columns:repeat(2,minmax(0,1fr));}
    #ee-events .ee-e-odgrid{grid-template-columns:repeat(2,minmax(0,1fr));}
    #ee-events .ee-e-grid .ee-e-card:nth-child(3){grid-column:1 / -1;}
  }
  @media (max-width:560px){
    #ee-events .ee-e-grid,#ee-events .ee-e-odgrid{grid-template-columns:1fr;}
    #ee-events .ee-e-grid .ee-e-card:nth-child(3){grid-column:auto;}
    #ee-events .ee-e-container{padding:0 18px;}
  }
  @media (prefers-reduced-motion:reduce){
    #ee-events .ee-e-card,#ee-events .ee-e-od,
    #ee-events .ee-e-link svg,#ee-events .ee-e-od-link svg{transition:none;}
  }
</style>
  ...
  <div class="ee-e-container">
    ...
    <div class="ee-e-grid">
      ...
      <a class="ee-e-card" href="#demo">
        ...
        <span class="ee-e-link">Register free <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span>
      </a>
    ...
    <div class="ee-e-odgrid">
      ...
      <a class="ee-e-od" href="#demo">
        <span class="ee-e-play" aria-hidden="true"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg></span>
        <span class="ee-e-od-body">
          <span class="ee-e-od-title">Cutting Lead Response Time to Under 5 Minutes</span>
          <span class="ee-e-od-link">Watch now <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span>
        </span>
      </a>
...
<style id="ee-photos">
/* ===== Real photo backdrops (Unsplash CDN) with navy/violet overlay — graceful: if an image fails, the brand gradient still shows ===== */
/* Photos load in the visitor's browser on the live site. Swap any URL with your own hosted image anytime. */

/* turn off the graphic motif where a photo takes over (avoids clutter) */
#stories::before,#integrations::before,#security::before,#ee-resources::before,#ee-events::before{ display:none!important; }

#stories,#integrations,#security,#ee-resources,#ee-events,#demo{
  background-attachment:fixed!important; background-position:center!important; background-size:cover!important; background-repeat:no-repeat!important;
}

/* Students / admissions — Stories */
#stories{
  background-image:
    radial-gradient(circle at 88% 8%, rgba(124,111,240,.18), transparent 46%),
    linear-gradient(180deg, rgba(244,247,252,.90), rgba(236,240,250,.93)),
    url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1600&q=55&auto=format&fit=crop')!important;
}
/* Digital transformation / network — Integrations */
#integrations{
  background-image:
    radial-gradient(circle at 12% 10%, rgba(124,111,240,.18), transparent 46%),
    linear-gradient(180deg, rgba(243,246,252,.90), rgba(235,239,250,.93)),
    url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1600&q=55&auto=format&fit=crop')!important;
}
/* Data / security */
#security{
  background-image:
    radial-gradient(circle at 85% 12%, rgba(124,111,240,.18), transparent 46%),
    linear-gradient(180deg, rgba(243,246,252,.91), rgba(234,238,250,.94)),
    url('https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1600&q=55&auto=format&fit=crop')!important;
}
/* Library / analytics — Resources */
#ee-resources{
  background-image:
    radial-gradient(circle at 90% 8%, rgba(124,111,240,.18), transparent 46%),
    linear-gradient(180deg, rgba(244,247,252,.90), rgba(236,240,250,.93)),
    url('https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=1600&q=55&auto=format&fit=crop')!important;
}
/* Events / webinars */
#ee-events{
  background-image:
    radial-gradient(circle at 10% 8%, rgba(124,111,240,.18), transparent 46%),
    linear-gradient(180deg, rgba(244,247,252,.90), rgba(236,240,250,.93)),
    url('https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1600&q=55&auto=format&fit=crop')!important;
}
/* Campus / university — Final CTA (kept light so the form stays readable) */
#demo{
  background-image:
    linear-gradient(180deg, rgba(244,247,252,.88), rgba(233,238,250,.92)),
    url('https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=1600&q=55&auto=format&fit=crop')!important;
...
@media (max-width:768px){
  #stories,#integrations,#security,#ee-resources,#ee-events,#demo{ background-attachment:scroll!important; }
}
</style>
<?php get_footer(); ?>
