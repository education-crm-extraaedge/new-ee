...
<style id="ee-flw">
  ...
  @media(min-width:900px){
    #feature-pillars.flw-on .flw-pin{height:min(calc(100vh - 90px),700px);height:min(calc(100svh - 90px),700px);justify-content:center;padding:0}
...
(function(){
  ...
  function setMode(){
    var want=!tooTall();
    if(want && !root.classList.contains('flw-on')){ root.classList.add('flw-on'); measure(); }
    else if(!want && root.classList.contains('flw-on')){
      root.classList.remove('flw-on');
      track.style.height=''; row.style.transform='';
  ...
  function upd(){
    tick=false;
    if(!root.classList.contains('flw-on')) return;   /* rail mode: native scroll owns the row */
  ...
  window.addEventListener('scroll',onScroll,{passive:true});
  window.addEventListener('resize',function(){clearTimeout(root.__t);root.__t=setTimeout(function(){setMode(); if(root.classList.contains('flw-on'))measure();},120);},{passive:true});
  if(document.fonts&&document.fonts.ready){document.fonts.ready.then(function(){if(root.classList.contains('flw-on'))measure();});}
  setMode();
  if(root.classList.contains('flw-on')){ measure(); setTimeout(measure,450); setTimeout(measure,1400); }
})();
</script>
...
<section id="ee-products" aria-label="Our products">
  ...
  (function(){
    ...
    var P = [
      ...
      {id:'clm', t:'Centralized Lead Management', cat:'platform', ic:'crm', href:'#admission-form',
        d:'Every lead from every source in one clean, deduplicated inbox.',
        l:'Website, portals, fairs, agents, walk-ins - every enquiry lands in one deduplicated queue and is auto-assigned to the right counsellor.',
        tags:['All sources unified','Auto-deduplication','Smart assignment']},
      {id:'integrations', t:'Seamless Integrations', cat:'platform', ic:'gear', href:'#admission-form',
        d:'Plug into portals, telephony, payments and ERPs without custom code.',
        l:'Ready connectors for lead portals, telephony, payment gateways and ERPs - your stack talks to your CRM out of the box.',
        tags:['Portal connectors','Telephony & payments','ERP sync']},
      {id:'success', t:'Dedicated Customer Success', cat:'platform', ic:'heart', href:'#admission-form',
        d:'A named success manager who tunes the platform to your admissions.',
        l:'Onboarding, training and quarterly reviews from a dedicated success manager who knows your funnel inside out.',
        tags:['Named manager','Hands-on onboarding','Quarterly reviews']},
      {id:'ems', t:'Enrollment Management System', cat:'admissions', ic:'shield', href:'#admission-form',
      ...
      {id:'srs', t:'Student Recruitment Software', cat:'admissions', ic:'globe', href:'#admission-form',
      ...
      {id:'walkin', t:'Walk-in Management System', cat:'admissions', ic:'doc', href:'#admission-form',
      ...
      {id:'abroad-crm', t:'Study Abroad CRM', cat:'platform', ic:'globe', href:'#admission-form',
      ...
      {id:'univ-crm', t:'University CRM', cat:'platform', ic:'crm', href:'#admission-form',
      ...
      {id:'school-crm', t:'School CRM', cat:'platform', ic:'crm', href:'#admission-form',
      ...
      {id:'coaching-crm', t:'Coaching CRM', cat:'platform', ic:'crm', href:'#admission-form',
      ...
      {id:'he-crm', t:'Higher Education CRM', cat:'platform', ic:'crm', href:'/industries/higher-education-crm/',
