...
.head{max-width:780px;margin:0 auto;text-align:center}.h2{font-family:'Poppins',sans-serif;font-size:clamp(30px,4vw,46px);font-weight:800;letter-spacing:-1.2px;line-height:1.1}.lead{color:var(--muted);font-size:18px;margin-top:16px}.sec{padding:88px 0}.sec--soft{background:var(--bg-soft)}/* reveal */
...
.stats{display:grid;grid-template-columns:repeat(4,1fr);gap:18px}.stat{text-align:center;padding:28px 18px;border-radius:18px;background:#fff;border:1px solid var(--line);box-shadow:var(--shadow-sm)}.stat__n{font-family:'Poppins',sans-serif;font-size:46px;font-weight:800;letter-spacing:-2px;line-height:1}.stat__l{color:var(--muted);font-size:14px;margin-top:8px;font-weight:600}/* ===================== CAPS ===================== */
...
<style>#ee-vidya-suite{
  ...
  #ee-vidya-suite .vsx-ic.vsx-ic--img{ background:transparent; padding:0; overflow:hidden; }#ee-vidya-suite .vsx-ic.vsx-ic--img img{ width:100%; height:100%; object-fit:cover; display:block; border-radius:inherit; }#ee-vidya-suite .vsx-card h3{ font-family:'Poppins','Inter',sans-serif; font-weight:600; font-size:21px; color:#fff; margin:4px 0 0; letter-spacing:-.01em; }#ee-vidya-suite .vsx-card .vsx-desc{ font-size:13.5px; line-height:1.55; color:#c2d0e4; margin:0; }/* features list */
...
#ee-ind .spx-ic{ position:relative; width:56px; height:56px; border-radius:17px; display:grid; place-items:center;
  background:linear-gradient(150deg,var(--g1),var(--g2)); margin-bottom:16px; transform:translateZ(30px);
...
@media(max-width:600px){
  #ee-ind .spx-grid{ grid-template-columns:1fr; gap:12px; }
  #ee-ind .spx-wrap{ padding:18px 18px 22px; }
  #ee-ind .spx-head{ margin-bottom:22px; }
  #ee-ind .spx-card{ padding:20px 18px 18px; border-radius:22px; }
  #ee-ind .spx-ic{ width:48px; height:48px; border-radius:14px; }
  #ee-ind .spx-ic svg{ width:23px; height:23px; }
  #ee-ind .spx-card h3{ font-size:15.5px; }
  #ee-ind .spx-card p{ font-size:12px; }
}
