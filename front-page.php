...
?>
<!-- ee-front-tpl v2026-07-28-platformmods -->
<!--
...
<section class="logo-section" id="trusted-institutions" aria-label="Trusted Institutions">
  ...
  <div class="marquee-wrap">
    <div class="marquee-track marquee-left">
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/d-y-patil-university-ambi-u2013pune-logo.svg" alt="D Y Patil University Ambi Pune — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/overseas/aip-education-pty-ltd-aus-logo.svg" alt="Aip Education Pty Ltd Aus — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/iitm-college-of-engineering-logo.svg" alt="Iitm College of Engineering — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/sree-sloka-sai-dattatreya-edu-society-logo.svg" alt="Sree Sloka Sai Dattatreya Edu Society — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/edtech/seamless-education-services-logo.svg" alt="Seamless Education Services — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/coaching%20institute%20crm/ignite-academy-logo.svg" alt="Ignite Academy — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/coaching%20institute%20crm/the-quantium-school-vedaantha-fdn-logo.svg" alt="The Quantium School Vedaantha Fdn — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/edtech/dq-labs-pvt-ltd-logo.svg" alt="Dq Labs Pvt Ltd — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/vikrant-university-logo.svg" alt="Vikrant University — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/coaching%20institute%20crm/results-consortium-ltd-logo.svg" alt="Results Consortium Ltd — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/coaching%20institute%20crm/iitians-prashikshan-kendra-logo.svg" alt="Iitians Prashikshan Kendra — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/d-y-patil-pgdm-institute-akurdi-logo.svg" alt="D Y Patil Pgdm Institute Akurdi — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/school-of-innovation-and-management-logo.svg" alt="School of Innovation and Management — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/bareilly-scholars-educational-society-kcmt-logo.svg" alt="Bareilly Scholars Educational Society Kcmt — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/vocational/gold-gym-logo.svg" alt="Gold Gym — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/vocational/career-buddy-placement-and-training-logo.svg" alt="Career Buddy Placement and Training — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/park-s-college-logo.svg" alt="Park S College — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/academy-of-applied-arts-logo.svg" alt="Academy of Applied Arts — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/reliance-foundation-inst-of-edu-and-research-jio-logo.svg" alt="Reliance Foundation Inst of Edu and Research Jio — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/toms-college-of-engineering-logo.svg" alt="Toms College of Engineering — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/vocational/the-language-skool-logo.svg" alt="The Language Skool — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/d-y-patil-university-ambi-u2013pune-logo.svg" alt="D Y Patil University Ambi Pune — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/overseas/aip-education-pty-ltd-aus-logo.svg" alt="Aip Education Pty Ltd Aus — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/iitm-college-of-engineering-logo.svg" alt="Iitm College of Engineering — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/sree-sloka-sai-dattatreya-edu-society-logo.svg" alt="Sree Sloka Sai Dattatreya Edu Society — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
    ...
    <div class="marquee-track marquee-right" style="margin-top:16px">
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/fortune-cloud-technologies-logo.svg" alt="Fortune Cloud Technologies — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/dalhousie-public-school-edu-society-logo.svg" alt="Dalhousie Public School Edu Society — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/overseas/mit-univista-global-tech-logo.svg" alt="Mit Univista Global Tech — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/aishwarya-college-udaipur-logo.svg" alt="Aishwarya College Udaipur — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/kishkinda-university-logo.svg" alt="Kishkinda University — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/edtech/mindcreed-logo.svg" alt="Mindcreed — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/trillium-foundation-logo.svg" alt="Trillium Foundation — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/edtech/nilaya-edutech-pvt-ltd-logo.svg" alt="Nilaya Edutech Pvt Ltd — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/etherial-education-pvt-ltd-or-united-group-of-institute-logo.svg" alt="Etherial Education Pvt Ltd Or United Group of Institute — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/vocational/pixel-pop-academy-pvt-ltd-logo.svg" alt="Pixel Pop Academy Pvt Ltd — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/seth-anandram-jaipuria-school-kanpur-logo.svg" alt="Seth Anandram Jaipuria School Kanpur — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/vocational/nips-school-of-hotel-management-logo.svg" alt="Nips School of Hotel Management — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/coaching%20institute%20crm/dr-rajkumar-academy-for-civil-services-logo.svg" alt="Dr Rajkumar Academy for Civil Services — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/velammal-vidhyashram-logo.svg" alt="Velammal Vidhyashram — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/atharva-university-mumbai-logo.svg" alt="Atharva University Mumbai — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/iibm-institute-of-business-mgmt-logo.svg" alt="Iibm Institute of Business Mgmt — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/modern-groups-of-institute-logo.svg" alt="Modern Groups of Institute — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/vocational/ebek-language-laboratories-logo.svg" alt="Ebek Language Laboratories — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/edtech/srj-edu-services-pvt-ltd-logo.svg" alt="Srj Edu Services Pvt Ltd — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/universal-wisdom-school-logo.svg" alt="Universal Wisdom School — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/shree-om-university-logo.svg" alt="Shree Om University — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/fortune-cloud-technologies-logo.svg" alt="Fortune Cloud Technologies — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/school/dalhousie-public-school-edu-society-logo.svg" alt="Dalhousie Public School Edu Society — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/overseas/mit-univista-global-tech-logo.svg" alt="Mit Univista Global Tech — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
      <div class="logo-card"><img src="https://www.extraaedge.com/wp-content/uploads/2026/all-institues-logo/higher%20education/aishwarya-college-udaipur-logo.svg" alt="Aishwarya College Udaipur — ExtraaEdge admissions CRM" loading="lazy" onerror="this.closest('.logo-card').remove()"></div>
    ...
    <section class="w-full relative py-12 lg:py-24 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div style="display:flex;align-items:center;justify-content:center;gap:12px;margin-bottom:10px">
                <img src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/01-VidyaAI-Intelligence.svg" alt="VidyaAI" style="width:40px;height:40px;border-radius:10px;object-fit:contain;flex-shrink:0;background:#FFF4EE;padding:7px">
            </div>
                ...
                <div class="lg:col-span-5 z-20" id="navColumn">
                    <div id="navCard" class="bg-white/95 backdrop-blur-md p-2 sm:p-4 rounded-2xl border border-slate-100 shadow-figma space-y-2">
                        ...
                        <button onclick="scrollToSection('vidyaai')" id="nav-vidyaai" aria-current="true" class="feature-nav-item active w-full text-left p-3.5 rounded-xl border border-transparent transition-all duration-300 flex items-center justify-between group relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3.5 pl-2">
                                <div class="w-10 h-10 rounded-lg bg-brand-navy/5 group-hover:bg-brand-orange/10 flex items-center justify-center text-brand-navy group-hover:text-brand-orange transition-colors nav-icon">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/01-VidyaAI-Intelligence.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em;font-size:1.125rem">
                                </div>
                                <div>
                        ...
                        <button onclick="scrollToSection('admission-crm')" id="nav-admission-crm" class="feature-nav-item w-full text-left p-3.5 rounded-xl border border-transparent transition-all duration-300 flex items-center justify-between group relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3.5 pl-2">
                                <div class="w-10 h-10 rounded-lg bg-brand-navy/5 group-hover:bg-brand-orange/10 flex items-center justify-center text-brand-navy group-hover:text-brand-orange transition-colors nav-icon">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/02-Admission-CRM.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em;font-size:1.125rem">
                                </div>
                                <div>
                        ...
                        <button onclick="scrollToSection('marketing-automation')" id="nav-marketing-automation" class="feature-nav-item w-full text-left p-3.5 rounded-xl border border-transparent transition-all duration-300 flex items-center justify-between group relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3.5 pl-2">
                                <div class="w-10 h-10 rounded-lg bg-brand-navy/5 group-hover:bg-brand-orange/10 flex items-center justify-center text-brand-navy group-hover:text-brand-orange transition-colors nav-icon">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/03-Marketing-Automation.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em;font-size:1.125rem">
                                </div>
                                <div>
                        ...
                        <button onclick="scrollToSection('chatbot')" id="nav-chatbot" class="feature-nav-item w-full text-left p-3.5 rounded-xl border border-transparent transition-all duration-300 flex items-center justify-between group relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3.5 pl-2">
                                <div class="w-10 h-10 rounded-lg bg-brand-navy/5 group-hover:bg-brand-orange/10 flex items-center justify-center text-brand-navy group-hover:text-brand-orange transition-colors nav-icon">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/04-Chatbot-and-Live-Chat.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em;font-size:1.125rem">
                                </div>
                                <div>
                        ...
                        <button onclick="scrollToSection('application-mgmt')" id="nav-application-mgmt" class="feature-nav-item w-full text-left p-3.5 rounded-xl border border-transparent transition-all duration-300 flex items-center justify-between group relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3.5 pl-2">
                                <div class="w-10 h-10 rounded-lg bg-brand-navy/5 group-hover:bg-brand-orange/10 flex items-center justify-center text-brand-navy group-hover:text-brand-orange transition-colors nav-icon">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/05-Application-System.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em;font-size:1.125rem">
                                </div>
                                <div>
                        ...
                        <button onclick="scrollToSection('whatsapp-api')" id="nav-whatsapp-api" class="feature-nav-item w-full text-left p-3.5 rounded-xl border border-transparent transition-all duration-300 flex items-center justify-between group relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3.5 pl-2">
                                <div class="w-10 h-10 rounded-lg bg-brand-navy/5 group-hover:bg-brand-orange/10 flex items-center justify-center text-brand-navy group-hover:text-brand-orange transition-colors nav-icon">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/06-WhatsApp-API.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em;font-size:1.125rem">
                                </div>
                                <div>
                        ...
                        <button onclick="scrollToSection('mobile-crm')" id="nav-mobile-crm" class="feature-nav-item w-full text-left p-3.5 rounded-xl border border-transparent transition-all duration-300 flex items-center justify-between group relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3.5 pl-2">
                                <div class="w-10 h-10 rounded-lg bg-brand-navy/5 group-hover:bg-brand-orange/10 flex items-center justify-center text-brand-navy group-hover:text-brand-orange transition-colors nav-icon">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/07-Mobile-CRM.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em;font-size:1.125rem">
                                </div>
                                <div>
                ...
                <div class="lg:col-span-7 space-y-16 lg:space-y-24">
                    ...
                    <div id="vidyaai" class="story-card bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-figma hover:shadow-figma-hover transition-all duration-500 relative overflow-hidden group">
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            <span class="p-2.5 bg-brand-orange/10 text-brand-orange rounded-xl text-lg"><img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/08-VidyaAI-Admission-Intelligence.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"></span>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-brand-orange/30 transition-all">
                                <div class="flex items-center gap-2 mb-1 text-brand-navy font-semibold text-sm">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/09-AI-Admission-Assist.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"> AI Admission Assist
                                </div>
                            ...
                            <div class="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-brand-orange/30 transition-all">
                                <div class="flex items-center gap-2 mb-1 text-brand-navy font-semibold text-sm">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/10-AI-Lead-Intent-Scoring.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"> AI Lead Intent Scoring
                                </div>
                            ...
                            <div class="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-brand-orange/30 transition-all">
                                <div class="flex items-center gap-2 mb-1 text-brand-navy font-semibold text-sm">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/11-Smart-Follow-up-Intelligence.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"> Smart Follow-up Intelligence
                                </div>
                            ...
                            <div class="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-brand-orange/30 transition-all">
                                <div class="flex items-center gap-2 mb-1 text-brand-navy font-semibold text-sm">
                                    <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/12-AI-Calling-for-Qualification.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"> AI Calling for Qualification
                                </div>
                        ...
                        <div class="mt-4 p-4 rounded-xl bg-brand-navy text-white flex items-start gap-3">
                            <img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/13-Counselor-Performance-Intelligence.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em;font-size:1.125rem">
                            <div>
                    ...
                    <div id="admission-crm" class="story-card bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-figma hover:shadow-figma-hover transition-all duration-500 relative overflow-hidden group">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="p-2.5 bg-brand-navy/10 text-brand-navy rounded-xl text-lg"><img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/14-Core-System.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"></span>
                    ...
                    <div id="marketing-automation" class="story-card bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-figma hover:shadow-figma-hover transition-all duration-500 relative overflow-hidden group">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="p-2.5 bg-brand-orange/10 text-brand-orange rounded-xl text-lg"><img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/18-Engagement-Engine.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"></span>
                    ...
                    <div id="chatbot" class="story-card bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-figma hover:shadow-figma-hover transition-all duration-500 relative overflow-hidden group">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="p-2.5 bg-brand-navy/10 text-brand-navy rounded-xl text-lg"><img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/22-24-7-Connectivity.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"></span>
                    ...
                    <div id="whatsapp-api" class="story-card bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-figma hover:shadow-figma-hover transition-all duration-500 relative overflow-hidden group">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="p-2.5 bg-emerald-500/10 text-emerald-600 rounded-xl text-lg"><img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/28-Direct-Channel.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"></span>
                    ...
                    <div id="mobile-crm" class="story-card bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-figma hover:shadow-figma-hover transition-all duration-500 relative overflow-hidden group">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="p-2.5 bg-brand-navy/10 text-brand-navy rounded-xl text-lg"><img class="eeimg" src="https://www.extraaedge.com/wp-content/uploads/2026/home-page/powerfull-crm/icons/32-On-the-go-Productivity.svg" alt="" style="width:1em;height:1em;object-fit:contain;display:inline-block;vertical-align:-0.125em"></span>
...
<section id="ee-products" aria-label="Our products">
  <div class="eep-wrap">
    ...
    <div class="eep-explore-wrap" style="text-align:center;margin-top:clamp(26px,3.4vw,40px)">
      <a href="/products/" class="eep-explore-btn" style="display:inline-flex;align-items:center;gap:9px;background:#DE6E30;color:#fff;font-weight:700;font-size:16px;padding:15px 34px;border-radius:999px;box-shadow:0 14px 30px -10px rgba(222,110,48,.55);transition:transform .2s ease,box-shadow .2s ease;text-decoration:none" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform=''">
  ...
  <div class="wa-wrap">
    ...
    <div class="wa-rv">
      ...
      <div class="wa-panel" id="waPanel">
        <h3>📣 Bulk campaigns that feel 1:1</h3>
...
(function(){
  ...
  document.querySelectorAll('.wa-tab').forEach(tab=>tab.addEventListener('click',()=>{
    ...
    panel.innerHTML=`<h3>${d.h}</h3><p>${d.p}</p><div class="chips">${d.c.map(x=>`<span class="chip">${x}</span>`).join('')}</div>`;
