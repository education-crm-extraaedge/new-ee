<?php
/*
Plugin Name: EE Skeleton Review
Description: Homepage skeleton structure-review page with shared team comments. Open /skeleton-review/ or /wp-admin/admin-ajax.php?action=ee_skeleton_review
Version: 1.0
Author: ExtraaEdge
*/
if (!defined('ABSPATH')) exit;

/* Guard: no-op if the theme's functions.php ever ships the same embedded
   version, so the two can never double-register. */
